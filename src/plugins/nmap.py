                ...
                if m:
                    ...
                    if m.lastindex:
                        for i in range(m.lastindex + 1):
                            skey = '${}'.format(i)
                            for k in app:
                                if not app[k] or k in ['confidence']: continue
...
if __name__ == '__main__':
    ...
    msg = {
        "pro": "TCP",
        "inner": False,
        "data": "030000130ed000001234000201080002000000",
        "ip_str": "116.213.169.244",
        "ip": "116.213.169.244",
        "@timestamp": "2020-11-23T09:24:55.339Z",
        "@version": "1",
        "tag": "eno2",
        "geoip": {
            "country_name": "中国",
